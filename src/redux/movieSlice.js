...
export const movieSlice=createSlice({
    ...
    name:'Movie',
    initialState:[
        {id:uuidv4(),title: 'John Wick: Chapitre 4 ', genre:'Action',checked:false,
    ...
    {id:uuidv4(),title:'La Petite Sirène ' ,genre:'fantastique musical',checked:false,
    ...
    {id:uuidv4(),title:'Fast and Furious 10' ,genre:'Action',checked:false,
    ...
    {id:uuidv4(),title: 'Oppenheimer',genre:'Action',checked:false,
    description:'The story of American scientist, J. Robert Oppenheimer, and his role in the development of the atomic bomb.',
    rate:8.5,sortie:2023,
    imageSrc:'./images/film4.jpg',
    videoUrl:'https://tse2.mm.bing.net/th?id=OMB2.1IRRxpPEEGxHlQ&pid=15.1'},

    {id:uuidv4(),title:'Tyler Rake 2' ,genre:'Action',checked:false,
    ...
    {id:uuidv4(),title:'Equalizer 3' ,genre:'Action',checked:false,
